...
namespace ScintillaNET
{
    public partial class Scintilla
    {
        ...
        private void FireModified(NativeScintillaEventArgs ea)
        {
            ...
            else if ((modType & NativeMethods.SC_MOD_CHANGEANNOTATION) == NativeMethods.SC_MOD_CHANGEANNOTATION)
            {
                AnnotationChangedEventArgs acea = new AnnotationChangedEventArgs(scn.line);
