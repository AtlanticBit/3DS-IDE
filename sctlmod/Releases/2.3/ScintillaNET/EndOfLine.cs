...
namespace ScintillaNet
{
	...
	public class EndOfLine : TopLevelHelper
	{
		...
		/// </summary>
        /// <remarks>Changing this value does NOT change all EOL marks in a currently-loaded document.
        /// To do this, use <see cref="ConvertAllLines"/>ConvertAllLines.</remarks>
        ...
        /// <summary>
        /// Return as a string the characters used to mean end-of-line. This depends solely on the
        /// selected EOL mode.
        /// </summary>
