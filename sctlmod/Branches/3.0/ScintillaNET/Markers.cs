...
namespace ScintillaNet
{
	...
	public class MarkerCollection : TopLevelHelper
	{
		...
		{
			AddInstanceSet(line, Util.GetMarkerMask(markers));
		}
		...
		{
			return FindNextMarker(line.Number, Util.GetMarkerMask(markers));
		}
		...
		{
			return FindNextMarker(nextLine(), Util.GetMarkerMask(markers));
		}
		...
		public Marker FolderEnd
		{
			get
			{
				return new Marker(Scintilla, (int)Constants.SC_MARKNUM_FOLDEREND);
			}
		}
		...
		public Marker FolderOpenMid
		{
			get
			{
				return new Marker(Scintilla, (int)Constants.SC_MARKNUM_FOLDEROPENMID);
			}
		}
		...
		public Marker FolderOpenMidTail
		{
			get
			{
				return new Marker(Scintilla, (int)Constants.SC_MARKNUM_FOLDERMIDTAIL);
			}
		}
		...
		public Marker FolderTail
		{
			get
			{
				return new Marker(Scintilla, (int)Constants.SC_MARKNUM_FOLDERTAIL);
			}
		}
		...
		public Marker FolderSub
		{
			get
			{
				return new Marker(Scintilla, (int)Constants.SC_MARKNUM_FOLDERSUB);
			}
		}
		...
		public Marker Folder
		{
			get
			{
				return new Marker(Scintilla, (int)Constants.SC_MARKNUM_FOLDER);
			}
		}
		...
		public Marker FolderOpen
		{
			get
			{
				return new Marker(Scintilla, (int)Constants.SC_MARKNUM_FOLDEROPEN);
			}
		}
		...
		{
			return FindPreviousMarker(line.Number, Util.GetMarkerMask(markers));
		}
		...
		{
			return FindPreviousMarker(prevLine(), Util.GetMarkerMask(markers));
		}

		public Line FindPreviousMarker(IEnumerable<Marker> markers)
		{
			return FindPreviousMarker(nextLine(), Util.GetMarkerMask(markers));
		}
	...
	public class Marker : ScintillaHelperBase
	{
		...
		internal void SetForeColorInternal(Color value)
		{
			...
			NativeScintilla.MarkerSetFore(_number, Util.ColorToRgb(value));
		}
		...
		internal void SetBackColorInternal(Color value)
		{
			...
			NativeScintilla.MarkerSetBack(_number, Util.ColorToRgb(value));
		}
		...
		{
			NativeScintilla.MarkerDefinePixmap(_number, XpmConverter.ConvertToXPM(image, Util.ColorToHtml(transparentColor)));
		}
