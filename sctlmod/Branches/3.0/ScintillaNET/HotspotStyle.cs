	...
	public class HotspotStyle : TopLevelHelper
	{
		...
		public Color ActiveForeColor
		{
			get
			{
				...
				return Util.RgbToColor(NativeScintilla.GetHotSpotActiveFore());
			}
			set
			{
				...
				NativeScintilla.SetHotspotActiveFore(_useActiveForeColor, Util.ColorToRgb(value));
			}
		}
		...
		public Color ActiveBackColor
		{
			get
			{
				...
				return Util.RgbToColor(NativeScintilla.GetHotSpotActiveBack());
			}
			set
			{
				if (value.IsKnownColor)
				...
				NativeScintilla.SetHotspotActiveBack(_useActiveBackColor, Util.ColorToRgb(value));
			}
		}
