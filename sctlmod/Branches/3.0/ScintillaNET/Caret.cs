	...
	public class CaretInfo : TopLevelHelper
	{
		...
		public Color Color
		{
			get
			{
				...
				Color c = Util.RgbToColor(NativeScintilla.GetCaretFore());
			...
			set
			{
				...
				NativeScintilla.SetCaretFore(Util.ColorToRgb(value));
			}
		}
		...
		public Color CurrentLineBackgroundColor
		{
			get
			{
				...
				Color c = Util.RgbToColor(NativeScintilla.GetCaretLineBack());
			...
			set
			{
				...
				NativeScintilla.SetCaretLineBack(Util.ColorToRgb(value));
			}
		}
