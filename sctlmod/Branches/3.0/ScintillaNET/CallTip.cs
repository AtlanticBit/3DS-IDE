...
namespace ScintillaNet
{
	...
	public class CallTip : TopLevelHelper
	{
		...
		public Color ForeColor
		{
			get
			{
				return Scintilla.Styles.CallTipStyle.ForeColor;
			}
			set
			{
				Scintilla.Styles.CallTipStyle.ForeColor = value;
			}
		}
		...
		internal void SetForeColorInternal(Color value)
		{
			...
			NativeScintilla.CallTipSetFore(Util.ColorToRgb(value));
		}
		...
		public Color BackColor
		{
			get
			{
				return Scintilla.Styles.CallTipStyle.BackColor;
			}
			set
			{
				Scintilla.Styles.CallTipStyle.BackColor = value;
			}
		}
		...
		internal void SetBackColorInternal(Color value)
		{
			...
			NativeScintilla.CallTipSetBack(Util.ColorToRgb(value));
		}
		...
		public Color HighlightTextColor
		{
			...
			set
			{
				...
				NativeScintilla.CallTipSetForeHlt(Util.ColorToRgb(value));
			}
		}
