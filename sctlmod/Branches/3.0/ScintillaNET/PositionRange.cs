...
namespace ScintillaNet
{
	...
	/// </summary>
	public class PositionRange : ScintillaHelperBase, IComparable
	{
		...
		protected internal PositionRange() : base(null) { }

		public PositionRange(int start, int end, Scintilla scintilla)
			: base(scintilla)
		{
			if (start < end)
			{
		...
		public string Text
		{
			get
			{
				...
				try
				{
					...
					string ret = Util.IntPtrToString(Scintilla.Encoding, rng.lpstrText, len);
		...
		public bool IntersectsWith(PositionRange otherRange)
		{
		...
		{
			PositionRange r = obj as PositionRange;
			if (r == null)
				return false;
		...
		{
			PositionRange other = otherObj as PositionRange;
	...
	public class ManagedRange : PositionRange, IDisposable
	{
		...
		protected internal ManagedRange(PositionRange range)
