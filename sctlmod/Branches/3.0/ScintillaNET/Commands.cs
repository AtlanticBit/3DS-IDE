...
namespace ScintillaNet
{
	...
	public class Commands : TopLevelHelper
	{
		...
		{
			AddBinding(Util.GetKeys(shortcut), Keys.None, command);
		}
		...
		{
			AddBinding(Util.GetKeys(shortcut), modifiers, command);
		}
		...
		{
			RemoveBinding(Util.GetKeys(shortcut), Keys.None, command);
		}
		...
		{
			RemoveBinding(Util.GetKeys(shortcut), modifiers, command);
		}
		...
		{
			RemoveBinding(Util.GetKeys(shortcut), Keys.None);
		}
		...
		{
			RemoveBinding(Util.GetKeys(shortcut), modifiers);
		}
		...
		{
			return GetCommands(Util.GetKeys(shortcut), Keys.None);
		}
		...
		{
			return GetCommands(Util.GetKeys(shortcut), modifiers);
		}
