...
namespace ScintillaNet
{
	public class Line : ScintillaHelperBase
	{
		...
		{
			AddMarkerSet(Util.GetMarkerMask(markers));
			return this;
		}
		...
		{
			return FindNextMarker(Util.GetMarkerMask(markers));
		}
		...
		{
			return FindPreviousMarker(Util.GetMarkerMask(markers));
		}
