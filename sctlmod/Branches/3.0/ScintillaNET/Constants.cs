...
{
	//
	// NOTE: This should be made internal or placed in a namespace
	// that more clearly denotes it as interop code.
	//
	// NOTE: There is a command-line application under the Tools folder
	// called InterfaceParser that automates the extraction of this data
	// from the Scintilla.iface file included with the Scintilla source.
	//
	public static class Constants
	{
		...
		public const uint
			...
			SC_CACHE_PAGE = 2,
			SC_CACHE_DOCUMENT = 3,
			SC_CURSORNORMAL = unchecked((uint)-1),
			SC_CURSORWAIT = 4,
			SC_SEL_STREAM = 0,
			SC_SEL_RECTANGLE = 1,
			SC_SEL_LINES = 2,
