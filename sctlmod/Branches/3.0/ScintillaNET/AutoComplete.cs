...
namespace ScintillaNet
{
	...
	public class AutoComplete : TopLevelHelper
	{
		...
		{
			NativeScintilla.RegisterImage(type, XpmConverter.ConvertToXPM(image, Util.ColorToHtml(transparentColor)));
		}
		...
		{
			RegisterImages(XpmConverter.ConvertToXPM(images, Util.ColorToHtml(transparentColor)));
		} 
		#endregion
