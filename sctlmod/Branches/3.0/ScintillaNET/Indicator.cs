	...
	public class Indicator : ScintillaHelperBase
	{
		...
		public Color Color
		{
			get
			{
				...
				return Util.RgbToColor(NativeScintilla.IndicGetFore(_number));
			}
			set
			{
				Scintilla.ColorBag[ToString() + ".Color"] = value;
				NativeScintilla.IndicSetFore(_number, Util.ColorToRgb(value));
			}
		}
		...
		public PositionRange Search()
		{
			return Search(Scintilla.GetRange());
		}

		public PositionRange Search(PositionRange searchRange)
		{
			...
			return new PositionRange(foundStart, foundEnd, Scintilla);
		}

		public PositionRange Search(PositionRange searchRange, PositionRange startingAfterRange)
		{
		...
		public List<PositionRange> SearchAll()
		{
			return SearchAll(Scintilla.GetRange());
		}
			

		public List<PositionRange> SearchAll(PositionRange searchRange)
		{
			PositionRange foundRange = Scintilla.GetRange(-1, -1);

			List<PositionRange> ret = new List<PositionRange>();
			do
			{
