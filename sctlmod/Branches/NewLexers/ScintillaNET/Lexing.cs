...
{
    /// <summary>
    /// Determines the current lexing behavior of a <see cref="Sctintilla" /> control.
    /// </summary>
    ...
    public class Lexing : TopLevelHelper
    {
        ...
        /// <summary>
        /// Gets a collection to manage keywords used by the lexer.
        /// </summary>
        /// <returns>A keywords collection.</returns>
        [Browsable(false)]
        ...
        /// <summary>
        /// Gets or sets the current built-in lexer.
        /// </summary>
        /// <returns>One of the <see cref="Lexer" /> enumeration values.</returns>
        public Lexer Lexer
        {
            get
            {
